...
def system_rules_text(capabilities: Set[str]) -> str:
    ...
    return (
        ...
        "• Never display internal capability IDs (snake_case like answer_questions_about_me).\n"
"• If listing what you can help with, use friendly labels (e.g., 'my background', 'my projects', 'my skills and education').\n"
        "\n"
        "FORMATTING (VERY IMPORTANT):\n"
        "• When listing work history, ALWAYS use bullets.\n"
